...
wm.prefs.wallpaper = wm.awful.util.get_configuration_dir() .. "./wallpaper.jpg"
...
wm.prefs.mainmenu = {
  ...
  { "open terminal", wm.prefs.terminal }
}
...
screen.connect_signal("property::geometry", function(screen) wm:set_wallpaper(screen) end)
